    ...
    <>
      ...
      <main>
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate="novalidate">
          ...
          />
          <p>
            <span className="text-gray text-s mt-3 inline-block">
              ※パスワードは半角英数字、6〜12文字で入力してください。
            </span>
          </p>
          ...
          <p className="mt-10">
            ...
            />
            <br />
            <span className="text-gray sqtext-s mt-3 inline-block">
              ※登録できる画像：拡張子 - jpg・png、サイズ - 1MB以内
            </span>
          </p>
